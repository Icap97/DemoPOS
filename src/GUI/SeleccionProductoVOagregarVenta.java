 ...
 * @author irisa
 */
public class SeleccionProductoVOagregarVenta extends javax.swing.JDialog {
     ...
     * @param busqueda
     */
    public SeleccionProductoVOagregarVenta(javax.swing.JDialog parent, boolean modal, String busqueda) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ...
            for (int i = 0; i < listaProductos.size(); i++) {
               ...
               if(listaProductos.get(i).getCodigoBarras().equals(busqueda)){
                   ...
                   System.out.println(listaProductos.get(i).getCodigoBarras());
              modelo.addRow(A);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionProductoVOagregarVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SeleccionProductoVOagregarVenta dialog = new SeleccionProductoVOagregarVenta(new javax.swing.JDialog(), true, null);
